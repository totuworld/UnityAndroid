...
public class HelloAndroidActivity extends Activity
{
    ...
    // Unity가 호출하는 Method
    // 여기서 UnitySendMessage를 이용해서 다시 Unity로 값을 전달한다
    public void AnswerToUnity()
    {
        // gameobject name, method name, return value
        UnityPlayer.UnitySendMessage("UnityCom", "ResultFromAndroid", "What's up, Unity :)" );
    }
}
